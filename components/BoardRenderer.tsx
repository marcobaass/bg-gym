...
function drawCheckers(boardState, POINT_WIDTH, BOARD_WIDTH, BAR_X_START_RELATIVE, BAR_WIDTH, FRAME_WIDTH) {

  const CHECKER_RADIUS = POINT_WIDTH * 0.9 / 2
